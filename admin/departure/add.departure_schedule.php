...
if(isset($_POST['submit']))
{
	...
	VALUES ('$username','$ip_addr','Add into departure Schedule Table','".$_POST['departure_train_id']."','Add')";
	$conn->query($auditQry);
	$departure_train_id=$_POST['departure_train_id'];
	...
	$query="INSERT  INTO tbl_departure_schedule(departure_train_id,platform_no,destination,schedule_time,probable_time,status) 
	values($departure_train_id,'$platform','$destination','$schedule_time','$probable_time',0)";
	$conn->query($query);
...
<html>
<head>
<title>Insert departure Train Schedule</title>
...
<h1 class="page-header">Add departure Schedule</h1>
<div style="width:100% ">
  ...
  <table class="table-condensed table-hover ">
    <tr>
	  ...
	  <select name="departure_train_id"  id="departure_train_id"class="form-control">
		...
		?>
				<option value="<?php echo $row['departure_train_id']?>">
    ...
    <tr>	
      ...
      <td><input type="submit" name="submit" value="Submit Schedule" class="btn btn-success btn-sm" />
			<a href="display.departure_schedule.php" class="btn btn-info btn-sm">Display Train Schedule</a></td>
    </tr>
      </table>
</form>
</div>
