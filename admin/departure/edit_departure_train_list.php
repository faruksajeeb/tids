...
$xquery="select * from tbl_train_list_departure WHERE departure_train_id='".$_GET['id']."'";
...
$conn->query($auditQry);
$x="UPDATE tbl_train_list_departure SET train_no='".$_POST['txtdescription']."' ,train_name='".$_POST['cname']."' WHERE departure_train_id='".$_POST['hd']."' ";
$conn->query($x);
...
<html>
<head>
<title>Update ্departure train</title>
...
<h1 class="">Update departure train</h1>
