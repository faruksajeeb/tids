...
if(isset($_POST['submit']))
{
	...
	$conn->query($auditQry);
	$query="INSERT  INTO tbl_train_list_departure(train_no,train_name) VALUES('$trainno','$trainname')";
	$conn->query($query);	
...
<body>
<div class="middle" >
<h1 class="page-header">Add departure train</h1>
<div style="width:100% ">
...
<form name="form1" id="form1" method="post" action="" enctype="">
  ...
  <input name="txtupdate_by" type="hidden" id="txtupdate_by" class="form-control" value="<?php echo $_SESSION['user'];?>">
      <td>&nbsp;</td>
      <td><input type="submit" name="submit" id="submit" value="Submit" class="btn btn-success btn-sm" />   </tr>
      </table>
</form>
</div>
</div>
