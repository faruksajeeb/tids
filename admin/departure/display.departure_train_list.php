...
$query="SELECT * FROM tbl_train_list_departure";
$rst=$conn->query($query);
 if (isset($_GET['status'])) {
        if ($_GET['status'] == 'delete') {
            ...
            $q="delete from tbl_train_list_departure where departure_train_id=".$_GET['id']."";
            $conn->query($q);
            header("location:display.departure_train_list.php");
        }
   }
?>
<!DOCTYPE html>
...
<body>
<h1 class="page-header">Train deparutre</h1><hr/>
<form name="form1" method="post" action="">
	<a href="add.departure_train.php" class="btn btn-info btn-lg"><i class="fa fa-plus"></i> Add Train</a><br/>
...
<tbody>
    ...
    <tr>
      ...
      <td><?php echo $row[2]?></td>
		<td>
		<a href="edit_departure_train_list.php?id=<?php echo $row[0];?>" class="btn btn-info btn-xs"><span class="fa fa-pencil-square-o"> edit</span></a>	
