...
$auditQry = "INSERT into auditor(username,ipaddr,date_time,table_name,train_no,action) 
  VALUES ('$username','$ip_addr',now(),'departure_schedule','".$_POST['hd']."','cancel')";
$audit_result=mysql_query($auditQry);
$x="UPDATE departure_schedule SET status=0 WHERE trainno='".$_POST['hd']."' ";
$rst=mysql_query($x);
...
<html>
<head>
<title>Cancel Departure Schedule</title>
...
<body >
<div id="snow">
<h5 style="margin-top:50px">Are you sure you want to cancel from Schedule?</h5><br><br>
<form name="form1" id="form1" method="post" action="">
<input type="hidden" name="hd" id="hd" value="<?php echo $rows[0]?>">
<input type="submit" name="submit" value="Cancel from Schedule" class="btn btn-success btn-lg" />
</form>
</div>
</body>
</html>